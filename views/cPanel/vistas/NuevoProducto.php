			...
			<table class="tablaNuevoProducto">
				...
				<tr>
					<td align="center" colspan="2">
						<input type="button" class="btnSaveBook" onclick="saveBook()" value="Guardar Libro"><img class="loadingData" src='../imagenes/loading1.gif' style='margin-left:9px;margin-top:8px;position:absolute;width:40px;visibility:hidden;'>
					</td>
				</tr>
			</table>
		</form>